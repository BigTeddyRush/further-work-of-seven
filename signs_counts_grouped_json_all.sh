...
# Output file for variable counts of the specified JSON file
...
# Start building the output string for the JSON file
...
echo "Variable counts for union_n160_b4.json written to $variable_counts_output_file"