...
def evaluate(src: str, count: int = None):
    ...
    for name, test in tests.items():
        ...
        write_results(results, f"./results/filter_after_union_{src}_{name}.json")
