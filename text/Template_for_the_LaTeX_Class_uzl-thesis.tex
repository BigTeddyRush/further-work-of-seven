...
\UzLThesisSetup{
  Bachelorarbeit,
  Verfasst = {am}{Institut für Software Engineering und Programming Languages},
  Titel auf Deutsch = {Können semantische Ähnlichkeiten von Wörtern die Schlussfolgerungen des gesunden Menschenverstands verbessern?  Eine Fallstudie mit Prover E und SUMO.},
  Titel auf Englisch = { Can semantic similarities of words enhance common sense reasoning?  A case study with prover E and SUMO.},
  Autor = {Julian Britz},
  Betreuerin = {Prof. Dr. Diedrich Wolter},
  Studiengang = {Informatik},
  Datum = {1. Juli 2025},
...
\chapter{Grundlagen}%: Document Setup and Document Structure}
\label{chapter-use}
